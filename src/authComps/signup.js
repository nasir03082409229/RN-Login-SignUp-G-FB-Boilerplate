            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <View style={styles.inputContainer}>
                        <Icon style={styles.inputIcon} name="person" size={30} color="#5F4B8B" />
                    ...
                    <TouchableHighlight style={[styles.buttonContainer, styles.signupButton]} onPress={() => this.createUser()}>
                ...
                <View style={{ flex: 1, backgroundColor: 'white', height : Dimensions.get('window').height-450}}>
                    <Text> </Text>
                </View>
            </ScrollView>
